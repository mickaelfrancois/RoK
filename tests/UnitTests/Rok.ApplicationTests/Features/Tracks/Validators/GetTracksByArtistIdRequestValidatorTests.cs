...
public class GetTracksByArtistIdRequestValidatorTests
{
    [Fact(DisplayName = "fails_when_artist_id_is_zero")]
    public async Task fails_when_artist_id_is_zero()
    {
        GetTracksByArtistIdRequestValidator sut = new();
        GetTracksByArtistIdRequest request = new(0);
    ...
    {
        GetTracksByArtistIdRequestValidator sut = new();
        GetTracksByArtistIdRequest request = new(42);
