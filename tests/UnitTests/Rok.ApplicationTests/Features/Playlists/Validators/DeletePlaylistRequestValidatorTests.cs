...
public class DeletePlaylistRequestValidatorTests
{
    [Fact(DisplayName = "fails_when_id_is_zero")]
    public async Task fails_when_id_is_zero()
    {
        DeletePlaylistRequestValidator sut = new();
        DeletePlaylistRequest request = new() { Id = 0 };
    ...
    {
        DeletePlaylistRequestValidator sut = new();
        DeletePlaylistRequest request = new() { Id = 42 };
