...
namespace Rok.ApplicationTests.Features.Statistics;
...
public class GetStatisticsQueryHandlerTests
{
    ...
    public async Task Handle_ShouldAggregateTotals_AndListenedCounts_FromRepositories()
    {
        ...
        GetStatisticsQueryHandler handler = new(trackRepository.Object, albumRepository.Object, artistRepository.Object, genreRepository.Object);

        // Act
        UserStatisticsDto result = await handler.HandleAsync(new GetStatisticsQuery(), CancellationToken.None);
    ...
    public async Task Handle_ShouldGroupTracksByFileExtension_AndMarkUnknownWhenMissing()
    {
        ...
        GetStatisticsQueryHandler handler = BuildHandler(tracks, new(), new(), new());
    ...
    public async Task Handle_ShouldCountStudioAlbums_AsThoseWithoutLiveCompilationOrBestOfFlag()
    {
        ...
        GetStatisticsQueryHandler handler = BuildHandler(new(), albums, new(), new());
    ...
    private static GetStatisticsQueryHandler BuildHandler(List<TrackEntity> tracks, List<AlbumEntity> albums, List<ArtistEntity> artists, List<GenreEntity> genres)
    {
        Mock<ITrackRepository> trackRepository = new();
        trackRepository.Setup(r => r.GetAllAsync(It.IsAny<RepositoryConnectionKind>())).ReturnsAsync(tracks);
        Mock<IAlbumRepository> albumRepository = new();
        ...
        return new GetStatisticsQueryHandler(trackRepository.Object, albumRepository.Object, artistRepository.Object, genreRepository.Object);
    }
}
