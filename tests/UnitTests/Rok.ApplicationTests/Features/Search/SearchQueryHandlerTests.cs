...
namespace Rok.ApplicationTests.Features.Search;
...
public class SearchQueryHandlerTests
{
    ...
    public async Task Handle_ShouldAggregateResults_FromAlbumArtistAndTrackRepositories()
    {
        ...
        SearchQueryHandler handler = new(albumRepository.Object, artistRepository.Object, trackRepository.Object);

        // Act
        SearchDto result = await handler.HandleAsync(new SearchQuery { Name = "queen" }, CancellationToken.None);
