...
public class UpdateAlbumFavoriteRequestValidatorTests
{
    [Fact(DisplayName = "fails_when_id_is_zero")]
    public async Task fails_when_id_is_zero()
    {
        UpdateAlbumFavoriteRequestValidator sut = new();
        UpdateAlbumFavoriteRequest request = new(0, false);
    ...
    {
        UpdateAlbumFavoriteRequestValidator sut = new();
        UpdateAlbumFavoriteRequest request = new(42, true);
