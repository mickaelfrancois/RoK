...
public class UpdateArtistPictureDominantColorRequestValidatorTests
{
    [Fact(DisplayName = "fails_when_id_is_zero")]
    public async Task fails_when_id_is_zero()
    {
        UpdateArtistPictureDominantColorRequestValidator sut = new();
        UpdateArtistPictureDominantColorRequest request = new(0, null);
    ...
    {
        UpdateArtistPictureDominantColorRequestValidator sut = new();
        UpdateArtistPictureDominantColorRequest request = new(42, 123L);
