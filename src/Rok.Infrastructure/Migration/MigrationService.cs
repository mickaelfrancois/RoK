...
public class MigrationService(IDbConnection database, IEnumerable<IMigration>? migrations, ILogger<MigrationService> logger) : IMigrationService
{
    ...
    private void CreateTableGenres()
    {
        ...
        string table = builder.CreateTable("Genres")
            ...
            .WithColumn("isFavorite").OfType(SqlBuilder.EColumnType.Bool).AsNotNull()
    ...
    private void CreateTableArtists()
    {
        ...
        string table = builder.CreateTable("Artists")
            ...
            .WithColumn("isFavorite").OfType(SqlBuilder.EColumnType.Bool).AsNotNull("0")
    ...
    private void CreateTableAlbums()
    {
        ...
        string table = builder.CreateTable("Albums")
            ...
            .WithColumn("isLive").OfType(SqlBuilder.EColumnType.Bool).AsNotNull()
            .WithColumn("isCompilation").OfType(SqlBuilder.EColumnType.Bool).AsNotNull()
            .WithColumn("isBestof").OfType(SqlBuilder.EColumnType.Bool).AsNotNull()
    ...
    private void CreateTableTracks()
    {
        ...
        string table = builder.CreateTable("Tracks")
            ...
            .WithColumn("duration").OfType(SqlBuilder.EColumnType.Integer).AsNotNull().AsKey()
            .WithColumn("size").OfType(SqlBuilder.EColumnType.Integer).AsNotNull()
            .WithColumn("bitrate").OfType(SqlBuilder.EColumnType.Integer).AsNotNull()
            .WithColumn("novauid").OfType(SqlBuilder.EColumnType.Text).AsNull()
            .WithColumn("musicBrainzId").OfType(SqlBuilder.EColumnType.Text).AsNull()
            ...
            .WithColumn("isLive").OfType(SqlBuilder.EColumnType.Integer).AsNotNull()
            ...
            .WithColumn("skipCount").OfType(SqlBuilder.EColumnType.Integer).AsNotNull()
            .WithColumn("lastSkip").OfType(SqlBuilder.EColumnType.DateTime).AsNull()
            .WithColumn("creatDate").OfType(SqlBuilder.EColumnType.DateTime).AsNotNull().AsKey()
            .WithColumn("editDate").OfType(SqlBuilder.EColumnType.DateTime).AsNull()
            .ToSql();
