...
public class UpdateAlbumRequest : IRequest<Result<bool>>
{
...
public class UpdateAlbumRequestHandler(IAlbumRepository _albumRepository) : IRequestHandler<UpdateAlbumRequest, Result<bool>>
{
    public async Task<Result<bool>> Handle(UpdateAlbumRequest command, CancellationToken cancellationToken)
    {
