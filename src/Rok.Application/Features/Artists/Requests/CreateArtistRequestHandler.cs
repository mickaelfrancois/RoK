...
public class CreateArtistRequest : IRequest<Result<long>>
{
...
public class CreateArtistRequestHandler(IArtistRepository _artistRepository) : IRequestHandler<CreateArtistRequest, Result<long>>
{
    public async Task<Result<long>> Handle(CreateArtistRequest message, CancellationToken cancellationToken)
    {
